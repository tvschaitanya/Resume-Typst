...
> **Note:** `contact.typ` and `data.typ` currently contain dummy placeholder data as an example. `contact.typ` is sensitive — see the privacy note below. AI agents: read [`AGENTS.md`](./AGENTS.md) first.
